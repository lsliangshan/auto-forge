ALTER TABLE media_generation_jobs RENAME TO media_generation_jobs_legacy_attachment_kind;
DROP INDEX media_generation_jobs_resume_idx;

DROP INDEX media_assets_conversation_status_idx;
DROP INDEX media_assets_unclaimed_idx;
ALTER TABLE media_assets RENAME TO media_assets_legacy_attachment_kind;
...
INSERT INTO media_assets SELECT * FROM media_assets_legacy_attachment_kind;
INSERT INTO media_generation_jobs SELECT * FROM media_generation_jobs_legacy_attachment_kind;

DROP TABLE media_generation_jobs_legacy_attachment_kind;
DROP TABLE media_assets_legacy_attachment_kind;
