CREATE TABLE conversion_jobs_v21 (
  id TEXT PRIMARY KEY,
...
INSERT INTO conversion_jobs_v21 SELECT * FROM conversion_jobs;

CREATE TABLE conversion_artifacts_v21 (
  id TEXT PRIMARY KEY,
  owner_user_id TEXT NOT NULL,
  execution_id TEXT NOT NULL REFERENCES executions(id) ON DELETE CASCADE,
  conversion_job_id TEXT REFERENCES conversion_jobs_v21(id) ON DELETE SET NULL,
...
INSERT INTO conversion_artifacts_v21 SELECT * FROM conversion_artifacts;

DROP TABLE conversion_artifacts;
DROP TABLE conversion_jobs;

ALTER TABLE conversion_jobs_v21 RENAME TO conversion_jobs;
ALTER TABLE conversion_artifacts_v21 RENAME TO conversion_artifacts;
