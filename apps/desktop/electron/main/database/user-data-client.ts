...
import privacyConsentRevocationMigration from '../../../resources/user-cache-migrations/0007_privacy_consent_revocation.sql?raw'
import {
...
const USER_CACHE_MIGRATIONS = [
  ...
  { version: 7, source: privacyConsentRevocationMigration },
] as const
