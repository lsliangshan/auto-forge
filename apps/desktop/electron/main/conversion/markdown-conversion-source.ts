...
html { color: #1f2937; background: #ffffff; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; font-size: 11pt; line-height: 1.65; }
body { margin: 0; }
...
code { border-radius: 3px; padding: .1em .3em; background: #f3f4f6; font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: .9em; }
...
th, td { border: 1px solid #d1d5db; padding: .45em .65em; text-align: left; vertical-align: top; }
