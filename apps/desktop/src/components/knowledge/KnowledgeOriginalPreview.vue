...
.preview-toolbar > div:first-child { display: grid; gap: 1px; }.preview-toolbar strong { color: var(--af-graphite); font-size: 10px; }.preview-toolbar small { color: var(--af-text-muted); font-size: 8px; }
.pdf-controls { display: flex; align-items: center; gap: 5px; color: var(--af-text-muted); font-size: 8px; }
.pdf-controls button { min-height: 26px; border: 1px solid var(--af-border); border-radius: 6px; padding: 3px 7px; color: var(--af-text); background: var(--af-surface); cursor: pointer; font-size: 8px; }.pdf-controls button:disabled { cursor: wait; opacity: .5; }
...
.pdf-page > span { position: absolute; right: 8px; bottom: 7px; border-radius: 999px; padding: 3px 7px; color: #586173; background: rgb(255 255 255 / 82%); font-size: 7px; opacity: 0; transition: opacity .15s ease; }.pdf-page:hover > span { opacity: 1; }
.preview-overlay { position: absolute; z-index: 5; inset: 0; display: grid; place-items: center; color: var(--af-text-muted); background: color-mix(in srgb, var(--af-canvas) 88%, transparent); font-size: 10px; }.preview-overlay.standalone { position: static; min-height: 420px; }
...
.original-text { font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 11px; line-height: 1.75; white-space: pre-wrap; overflow-wrap: anywhere; }
.rich-document { font-size: 11px; line-height: 1.75; }.rich-document :deep(h1), .rich-document :deep(h2), .rich-document :deep(h3) { color: var(--af-graphite); }.rich-document :deep(table) { width: 100%; border-collapse: collapse; }.rich-document :deep(td), .rich-document :deep(th) { border: 1px solid var(--af-border-strong); padding: 6px 8px; }.rich-document :deep(img) { max-width: 100%; height: auto; }
.preview-fallback { display: grid; min-height: 100%; align-content: center; gap: 10px; padding: 28px; color: var(--af-text-muted); text-align: center; }.preview-fallback.standalone { min-height: 420px; }.preview-fallback strong { color: var(--af-graphite); font-size: 11px; }.preview-fallback p { margin: 0; font-size: 9px; }.preview-fallback pre { max-width: 760px; max-height: 480px; margin: 0 auto; overflow: auto; border: 1px solid var(--af-border); border-radius: 8px; padding: 18px; color: var(--af-text); background: var(--af-surface); font: 10px/1.7 inherit; text-align: left; white-space: pre-wrap; }
