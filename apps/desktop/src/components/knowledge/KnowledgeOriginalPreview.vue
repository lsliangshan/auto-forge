...
.preview-toolbar > div:first-child { display: grid; gap: 1px; }.preview-toolbar strong { color: var(--af-graphite); font-size: var(--af-knowledge-font-body); }.preview-toolbar small { color: var(--af-text-muted); font-size: var(--af-knowledge-font-caption); }
.pdf-controls { display: flex; align-items: center; gap: 5px; color: var(--af-text-muted); font-size: var(--af-knowledge-font-caption); }
.pdf-controls button { min-height: 26px; border: 1px solid var(--af-border); border-radius: 6px; padding: 3px 7px; color: var(--af-text); background: var(--af-surface); cursor: pointer; font-size: var(--af-knowledge-font-caption); }.pdf-controls button:disabled { cursor: wait; opacity: .5; }
...
.preview-overlay { position: absolute; z-index: 5; inset: 0; display: grid; place-items: center; color: var(--af-text-muted); background: color-mix(in srgb, var(--af-canvas) 88%, transparent); font-size: var(--af-knowledge-font-body); }.preview-overlay.standalone { position: static; min-height: 420px; }
