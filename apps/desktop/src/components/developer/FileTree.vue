...
.tree-row { gap: 4px; min-height: 28px; padding-top: 5px; padding-right: 6px; padding-bottom: 5px; font-family: ui-monospace, monospace; font-size: 11px; }.tree-row:hover { background: var(--af-surface-muted); }.tree-row > svg { width: 14px; height: 14px; flex: none; }.tree-row > svg:not(.tree-chevron) { color: var(--af-text-muted); }.tree-chevron { width: 11px !important; height: 11px !important; flex: none; }
...
.tree-context-menu button { border: 0; border-radius: 4px; padding: 7px 9px; color: var(--af-text); background: transparent; cursor: pointer; font-size: 12px; text-align: left; }.tree-context-menu button:hover { background: var(--af-surface-muted); }.tree-context-menu button.danger { color: var(--af-danger); }
