...
.execution-table { border: 1px solid var(--af-border); background: var(--af-surface); }.table-header, .execution-row { display: grid; grid-template-columns: 120px minmax(170px, 1fr) 90px 130px 58px; align-items: center; gap: 10px; padding: 10px 13px; }.table-header { color: var(--af-text-muted); background: var(--af-surface-muted); font-size: 11px; font-weight: 700; }.execution-row { width: 100%; border: 0; border-top: 1px solid var(--af-border); color: var(--af-text); background: var(--af-surface); cursor: pointer; font-size: 12px; text-align: left; }.execution-row:hover, .execution-row.selected { background: var(--af-cobalt-soft); }.execution-row > span:first-child { display: flex; align-items: center; gap: 7px; }.execution-row em { color: var(--af-cobalt); font-style: normal; }.af-empty h2 { color: var(--af-graphite); font-size: 18px; }.af-empty p { font-size: 13px; }
</style>
