...
<style scoped>
.page { padding: 18px; }.page-toolbar { display: flex; align-items: center; justify-content: space-between; margin-bottom: 14px; }.page-toolbar > div { display: flex; align-items: center; gap: 9px; }.page-toolbar span { color: var(--af-text-muted); font-size: 12px; }
.workflow-list { border: 1px solid var(--af-border); background: var(--af-surface); }.workflow-row { display: grid; grid-template-columns: 38px minmax(0, 1fr) auto; gap: 12px; align-items: center; padding: 15px; }.workflow-row + .workflow-row { border-top: 1px solid var(--af-border); }.workflow-row:hover { background: #fafbfd; }
.workflow-icon { display: grid; width: 34px; height: 34px; place-items: center; border-radius: 7px; color: var(--af-cobalt); background: var(--af-cobalt-soft); }.workflow-main { min-width: 0; border: 0; padding: 0; color: inherit; background: transparent; cursor: pointer; text-align: left; }.workflow-title { display: flex; align-items: center; gap: 8px; }.workflow-title span { color: var(--af-text-muted); font-family: ui-monospace, monospace; font-size: 11px; }.workflow-main p { margin: 5px 0 8px; color: var(--af-text-muted); font-size: 12px; overflow-wrap: anywhere; }
.workflow-meta { display: flex; flex-wrap: wrap; gap: 10px; font-size: 11px; }.workflow-meta span { color: var(--af-text-muted); }.workflow-meta .enabled { color: var(--af-success); }.workflow-meta .failed { color: var(--af-danger); }.workflow-meta .disabled { color: var(--af-warning); }.workflow-actions { display: flex; align-items: center; gap: 6px; }
.af-error p { margin: 5px 0 10px; }.af-empty h2 { color: var(--af-graphite); font-size: 18px; }.af-empty p { font-size: 13px; }
</style>
