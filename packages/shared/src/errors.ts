...
const safeErrorMessages: Record<AppErrorCode, string> = {
  ...
  MEMBERSHIP_CONFLICT: 'The membership changed before the operation completed.',
  SELF_MEMBERSHIP_CHANGE_FORBIDDEN: 'You cannot change your own membership.',
  KNOWLEDGE_BASE_LIMIT_EXCEEDED: 'The knowledge base limit for this membership was reached.',
  KNOWLEDGE_DOCUMENT_LIMIT_EXCEEDED: 'The knowledge document limit for this membership was reached.',
  SERVICE_UNAVAILABLE: 'The service is temporarily unavailable.',
  NOT_FOUND: 'The requested resource was not found.',
  CONFLICT: 'The requested operation conflicts with existing state.',
  SYNC_CONFLICT: 'The remote data changed before synchronization completed.',
  SYNC_FAILED: 'The data could not be synchronized.',
  UPGRADE_REQUIRED: 'Update AutoForge before synchronizing data.',
  IMPORT_CONFIRMATION_REQUIRED: 'Importing this local history requires confirmation.',
  OUTBOX_LIMIT_EXCEEDED: 'Too many local changes are waiting to synchronize.',
