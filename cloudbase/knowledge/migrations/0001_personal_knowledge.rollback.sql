...
REVOKE ALL ON FUNCTION public.autoforge_knowledge_complete_embedding_generation(varchar, varchar, varchar, bigint, varchar, varchar, bigint, varchar) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.autoforge_knowledge_validate_job_mutation_permit(varchar, varchar, varchar, varchar, varchar) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.autoforge_knowledge_issue_embedding_dispatch_permit(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.autoforge_knowledge_reserve_embedding_dispatch_attempt(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.autoforge_knowledge_mark_embedding_dispatch_started(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.autoforge_knowledge_record_embedding_dispatch_settlement_intent(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, boolean, varchar, varchar, varchar, varchar) FROM PUBLIC, anon, authenticated, service_role;
REVOKE ALL ON FUNCTION public.autoforge_knowledge_settle_embedding_dispatch_attempt(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar, varchar) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.autoforge_knowledge_store_embedding(bigint, varchar, varchar, varchar, varchar, bigint, varchar, integer, varchar, real[], varchar, varchar, varchar, varchar) FROM PUBLIC, anon, authenticated, service_role;
...
REVOKE ALL ON FUNCTION public.autoforge_knowledge_complete_base_purge(varchar, varchar, varchar, jsonb, varchar) FROM PUBLIC, anon, authenticated, service_role;
...
DROP FUNCTION IF EXISTS public.autoforge_knowledge_complete_embedding_generation(varchar, varchar, varchar, bigint, varchar, varchar, bigint, varchar);
...
DROP FUNCTION IF EXISTS public.autoforge_knowledge_issue_embedding_dispatch_permit(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar);
DROP FUNCTION IF EXISTS public.autoforge_knowledge_reserve_embedding_dispatch_attempt(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar);
DROP FUNCTION IF EXISTS public.autoforge_knowledge_mark_embedding_dispatch_started(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar);
DROP FUNCTION IF EXISTS public.autoforge_knowledge_record_embedding_dispatch_settlement_intent(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, boolean, varchar, varchar, varchar, varchar);
DROP FUNCTION IF EXISTS public.autoforge_knowledge_settle_embedding_dispatch_attempt(varchar, varchar, varchar, integer, bigint, varchar, varchar, varchar, varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar, varchar);
...
DROP FUNCTION IF EXISTS public.autoforge_knowledge_store_embedding(bigint, varchar, varchar, varchar, varchar, bigint, varchar, integer, varchar, real[], varchar, varchar, varchar, varchar);
DROP FUNCTION IF EXISTS public.autoforge_knowledge_validate_job_mutation_permit(varchar, varchar, varchar, varchar, varchar);
DROP FUNCTION IF EXISTS public.autoforge_knowledge_assert_worker_mutation_window(bigint, varchar, bigint, varchar, varchar, varchar, varchar, varchar, varchar, boolean);
...
DROP FUNCTION IF EXISTS public.autoforge_knowledge_complete_base_purge(varchar, varchar, varchar, jsonb, varchar);
