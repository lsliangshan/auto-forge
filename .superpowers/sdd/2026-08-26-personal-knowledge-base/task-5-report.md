...
- The exact stale root `/var/folders/25/rnl6td396v75_nnd5q3t1s1r0000gn/T/autoforge-knowledge-probe-jXq1CV` was moved recoverably, without a glob, to `/Users/liangshan/.Trash/autoforge-knowledge-probe-jXq1CV-task5-round4`; its `probe.txt` and `probe.afobj` remain there until Trash is emptied.
